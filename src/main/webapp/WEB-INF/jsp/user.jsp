			...
			<div id="orderdiv" style="display:none; position: absolute;top: 20%;left: 27%;width: 58%;height: 75%;border-color:#BDFCC9; border-width: 1px;border-style:solid;">
				...
				<div id="miniorderdiv" style="overflow:auto; position:absolute;text-align:center; left:0%; width:100%;height:85%;top:9%;">
					<div style='position:absolute;width: 100%;height: 5%;left: 0%;top: 0%;'>
						<!-- 订单号 -->
						<span class='badge badge-pill badge-dark' style='position:absolute;height:100%;width:25%;left:0%;top:0%;'>订单号</span>
						<!-- 日期-->
						<span class='badge badge-pill badge-warning' style='position:absolute;height:100%;width:30%;left:25%;top:0%;'>下单时间</span>
						<!-- 状态 -->
						<span class='badge badge-pill badge-danger' style='position:absolute;height:100%;width:35%;left:55%;top:0%;'>状态</span>
						<!-- 操作 -->
...
<script type="text/javascript">
	...
	function toorder(button){
		...
		window.open("${pageContext.request.contextPath}/toorder/"+ordernumber+"/0","订单详情");
	}
	...
	for(let i=0;i<noi;i++){
		...
		let tempdiv="<div style='position:absolute;width: 100%;height: 7%;left: 0%;top: "+(9+i*9)+"%;'><button onclick='toorder(this)' type='button' class='btn btn-outline-success btn-sm'style='position:absolute;width: 25%;height: 100%;left: 0%;top: 0%;'>"+oiordernumber[i]+"</button><button type='button' class='btn btn-outline-success btn-sm'style='position:absolute;width: 30%;height: 100%;left: 25%;top: 0%;'>"+tempdate+"</button><button type='button' class='btn btn-outline-success btn-sm'style='position:absolute;width: 35%;height: 100%;left: 55%;top: 0%;'>"+statusstring+"</button>"+handlestring;
